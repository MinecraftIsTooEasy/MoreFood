...
public class MFItems extends Item {
    ...
    public static final ItemFood ancient_metal_apple = (ItemFood) (new ItemFood(getItemId("ancient_metal_apple"), MFMaterials.ancient_metal_apple, 2, 1, -3000, false,false, true, "ancient_metal_apple")).setPlantProduct().setAlwaysEdible().setMaxStackSize(16);
